...
// const Testimony = () => {
//     return (
//         <><h3 className='text-3xl text-amber-500 font-bold mt-3'>Testimony</h3>
//         <div className=" h-72 bg-base-100 shadow-2xl mb-3 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 ">
//             <figure><img className='w-96' src={img1} alt="Movie" /></figure>
//             <div className="">

//                 <p>I have always struggled to find the perfect beauty productsb that suit my skin type and enhance  my natural beauty. But ever since I discovered newMua, I have been amazed by their extensive selection of high-quality skincare and makeup. Not only do their products make me feel confident and radiant, but the expert advice from their friendly staff has been a game-changer for my beauty routine. Thanks to newMua,  It is not just a beauty shop; it is a beauty sanctuary.</p>
